...
window.Typekit.config = {
    ...
    "fc": [{
        ...
        "src": "https://use.typekit.net/af/14388e/00000000000000003b9acb60/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "italic",
    ...
    },
    {
        ...
        "src": "https://use.typekit.net/af/675b22/000000000000000000015670/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
    ...
    },
    {
        "id": 24324,
        "family": "clarendon-text-pro",
        "src": "https://use.typekit.net/af/1e24dc/000000000000000000015671/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "italic",
            "primer": "7ceb210e49ade74e23101e10f006f110a0b6588c7c57777a6e3d98a38b749696"
...
/*{"k":"1.18.23","auto_updating":true,"last_published":"2017-03-20 21:45:35 UTC"}*/
; (function(window, document, undefined) {
    ...
    fa.prototype.has = function(a) {
        ...
        for (var b = "number" === typeof a,
        c = 0; c < this.i; c++) {
            var d;
            if (b) d = r(a & 4294967295, 3432918353),
            d = d << 15 | d >>> 17,
            d = r(d, 461845907),
            d ^= ga[c] || 0,
            d = d << 13 | d >>> 19,
            ...
            d = (d >>> 0) % this.b;
                ...
                h = a.length - g;
                for (f = 0; f < h; f += 4) e = (a.charCodeAt(f + 0) & 4294967295) << 0 | (a.charCodeAt(f + 1) & 4294967295) << 8 | (a.charCodeAt(f + 2) & 4294967295) << 16 | (a.charCodeAt(f + 3) & 4294967295) << 24,
                e = r(e, 3432918353),
                e = e << 15 | e >>> 17,
                e = r(e, 461845907),
                d ^= e,
    ...
    function ha(a) {
        ...
        if (window.atob) a = window.atob(a);
            ...
            for (var b = 0,
            c, d, e = 0,
            f = ""; d = a.charAt(e++);~d && (c = b % 4 ? 64 * c + d: d, b++%4) ? f += String.fromCharCode(255 & c >> ( - 2 * b & 6)) : 0) d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(d);
            a = f
        }
        c = [];
    ...
    function oa(a, b) {
        if ("i" === b) {
            ...
            for (var e in c) {
                for (var f = [400, 300, 200, 100, 500, 600, 700, 800, 900], g = 400, h = 0; h < f.length; h++) if (g = f[h], c[e][g]) {
                    na(d, c[e][g]);
                    break
                }
    ...
    function xa(a, b, c) {
        for (var d in P) if (P.hasOwnProperty(d) && b === a.g[P[d]] && c === a.g[P[d]]) return ! 0;
        return ! 1
    }
    function wa(a) {
        var b = a.i.b.offsetWidth,
        c = a.j.b.offsetWidth,
        d; (d = b === a.g.serif && c === a.g["sans-serif"]) || (d = va() && xa(a, b, c));
    ...
    function Aa(a, b, c) {
        ...
        if (!e && c) C(a.b);
            ...
            function(b) {
                ...
                T ? c = new za(k(a.i, a), k(a.j, a), a.w, b, a.A, "BESbswy\ue000\ue001\ue002\ue003\ue004\ue005\ue006", a.u) : c = new ua(k(a.i, a), k(a.j, a), a.w, b, a.A, d, "BESbswy\ue000\ue001\ue002\ue003\ue004\ue005\ue006", a.u);
                f.push(c)
            });
    ...
    W = new U(Ha);
    n.ping && (W.m = new Ga);
    if (n.fc) for (var X = n.fc,
    Y = 0; Y < X.length; Y++) W.o.b.push(new la(X[Y].family, X[Y].src, X[Y].descriptors));
    if (n.dl) {
        var Ia = n.dl;
        try {
            W.j = new ha(Ia)
    ...
    n.kt && (W.u = n.kt);
    n.token && (W.i = n.token);
    if (n.c) for (var q = 0; q < n.c.length; q += 2) W.g.push(new da);
        ...
        window.Typekit.load = function(a) {
            ...
            a.active = function() {
                ...
                if (!window.XDomainRequest) {
                    ...
                    a.onload = function() {
                        for (var a = !1,
                        b = 0; b < document.styleSheets.length; b++) if (null === document.styleSheets[b].href && /ghostery-purple-box/.test(document.styleSheets[b].ownerNode.textContent)) {
                            a = !0;
                            break
                        }
                        c(a)
            ...
            a.fontactive = function(a, b) {
                ...
                a: {
                    ...
                    h += "00";
                    for (var l = n.fc,
                    p = 0; p < l.length; p++) if (l[p].family === a && l[p].descriptors.weight === h && l[p].descriptors.style === g) {
                        g = l[p].id;
                        break a
                    }
                    g = 0
